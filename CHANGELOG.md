...
- **Shinobi Scoring** — `shinobi_pm` added to acceptable effectors for RF-emitting commercial drones. No longer penalized as a "poor choice."
...
- SHINOBI countermeasure (protocol manipulation).
